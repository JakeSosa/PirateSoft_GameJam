...
@onready var animation_player_lever = $AnimationPlayer_Lever
...
# water fall lever var
@onready var lever_area_enter : bool = false
...
func _on_lever_lever_not_in_range():
	lever_area_enter = false


func _on_lever_lever_in_range():
	lever_area_enter = true
	print ("signal_recieved")

func _input(event):
	if Input.is_action_just_pressed("lightTorch") and lever_area_enter == true:
		print ("lever pressed")
		kill_waterfall.emit()
