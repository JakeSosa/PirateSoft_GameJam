...
#TUTOTIRAL SCONCE SCRIPT ONLY

#Set public variable that will act as a pointer to the player in scene
@export var player : CharacterBody3D

#Sconce variables
#Set variable to define visibility of sconce light in scene
@onready var sconce = $OmniLight3D
#Make sconce_color public to assign unique color to the sconce in scene
@export var sconce_color : Color
#Set variable to have particle color match sconce color
var particle_color : Color 
#Set variable to define when player is near sconce
...
func _ready():
	sconce.visible = true
	sconce.light_color = sconce_color
	particle_color = sconce_color
