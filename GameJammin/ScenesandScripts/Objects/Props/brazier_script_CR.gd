...
#Create brazier_light variable to define object's OmniLight, we'll match it to brazier_color
@onready var brazier_light = $OmniLight3D
#Create brazier_particle variable to define object's GPUParticles, we'll match it to brazier_color
@onready var brazier_particle = $GPUParticles3D
...
func _ready():
	brazier_light.light_color = brazier_color
	brazier_particle.process_material.color = brazier_color
